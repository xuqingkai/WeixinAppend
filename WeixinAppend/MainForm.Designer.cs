namespace Com.Youlaiyouqu.WeixinAppend
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Text = "一，启动数设为0，不会触发自动打开微信，需手动调整数字（滚轮）后点启动按钮。\n二，启动数设为1，软件启动后自动打开一个微信客户端\n三，启动数设为2,3,...，软" +
    "件启动后，自动打开指定个数的微信客户端，并重新排版窗口，使其相互不遮挡，如果当前已有打开的微信客户端，则只会打开一个新的微信客户端";
            // 
            // MainForm
            // 
